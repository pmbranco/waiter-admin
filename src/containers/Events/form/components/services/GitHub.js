...
import { asyncValidateGithub as asyncValidate } from './asyncValidate'
...
const validate = values => {
  const errors = {}
  const requiredFields = ['githubRepoURL']
...
export class GitHubInput extends Component {
  render() {
    ...
    return (
      <div>
        <Grid container direction="column">
          <Grid item>
            <Field name="githubRepoURL" component={renderTextField} label="URL" />
          </Grid>
          <Grid item>
            {owner &&
              repo && (
